...
W danym momencie, w aplikacji aktywny mo¿e byæ tylko jeden widok z jednym kontrolerem. Prze³¹czanie pomiêdzy widokami realizowane jest przez intencje (ang. intent).


//TODO intent helper, lista aktywnoœci, nawigacja w aplikacji



		\subsection{Komunikacja z serwerem} \indent \par \label{komunikacja_android}
		\subsection{Rejestracja konta} \indent \par
