...
Projekt interfejsu aplikacji mobilnej zosta³ wykonany w oparciu o wskazówki Material design\cite{design} opracowane przez Google. Po implementacji niektóre elementy interfejsu mog¹ ró¿niæ siê nieznacznie od zaprojektowanych, zale¿nie od dostêpnych 
